...
- [X] Move completed story files into `tasks/completed/stories/E46/`.
- [X] Move this epic file into `tasks/completed/epics/` after all stories are complete.

## Ordered stories

- [X] `E46-S01` — [Quest content and variable schema](../stories/E46/E46-S01_quest-content-and-variable-schema.md)
- [X] `E46-S02` — [Baker dialogue and quest start hook](../stories/E46/E46-S02_baker-dialogue-and-quest-start-hook.md)
- [X] `E46-S03` — [Gather, kill, and light objectives](../stories/E46/E46-S03_gather-kill-and-light-objectives.md)
- [X] `E46-S04` — [Quest rewards and completion](../stories/E46/E46-S04_quest-rewards-and-completion.md)
- [X] `E46-S05` — [Quest journal UI and end-to-end test](../stories/E46/E46-S05_quest-journal-ui-and-end-to-end-test.md)

## Epic acceptance criteria

- [X] All listed story files are complete and moved to the completed folder.
- [X] The "Smoke Over Old Town" quest can be started by talking to Pippa Hearth.
- [X] The quest tracks gathering 3 dry logs, killing 2 cellar rats, and lighting the oven.
- [X] Completing the quest gives bread, coins, Cooking XP, 1 Quest Point, and unlocks the bakery range.
- [X] The quest journal UI shows active and completed quests.
- [X] An end-to-end test completes the quest via tick commands and asserts final state.
- [X] No quest logic is hardcoded in engine code; all stages, dialogue, and rewards are content-driven.
