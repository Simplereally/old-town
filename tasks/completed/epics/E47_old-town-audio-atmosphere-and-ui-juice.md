...
- [X] Confirm all audio and visual assets are original/licensed for use; do not use OSRS/Jagex assets.
- [X] Move completed story files into `tasks/completed/stories/E47/`.
- [X] Move this epic file into `tasks/completed/epics/` after all stories are complete.

## Ordered stories

- [X] `E47-S00` — [Audio content pipeline and client exposure](../stories/E47/E47-S00_audio-content-pipeline-and-client-exposure.md)
- [X] `E47-S01` — [Ambient sound and district audio manager](../stories/E47/E47-S01_ambient-sound-and-district-audio-manager.md)
- [X] `E47-S02` — [UI and packet audio cues](../stories/E47/E47-S02_ui-and-action-sound-effects.md)
- [X] `E47-S03` — [Lighting, shadows, and day/night foundation](../stories/E47/E47-S03_lighting-shadows-and-day-night-foundation.md)
- [X] `E47-S04` — [Feedback polish and selection rings](../stories/E47/E47-S04_feedback-polish-and-selection-rings.md)
- [X] `E47-S05` — [Atmosphere validation and performance pass](../stories/E47/E47-S05_atmosphere-validation-and-performance-pass.md)

## Epic acceptance criteria

- [X] `content/audio/` validates through the normal content pipeline and is serialized to the client.
- [X] The client can determine the player's current audio zone/district from loaded region data.
- [X] Every starter-town audio zone has an ambience definition or an explicit silent fallback.
- [X] Existing server `SoundPacket`s produce audible client playback through one canonical `sounds.play` path.
- [X] UI sounds are immediate, subtle, volume-controlled, and original.
- [X] Blob shadows render under actors and selected static objects without exceeding measured renderer budgets.
- [X] Hitsplats, XP drops, and click markers remain server/client wired through the existing layers; no duplicate layers are introduced.
- [X] A persistent selection/target ring exists and is distinct from hover highlighting.
- [X] Day/night presentation changes sky, fog, hemisphere light, and sun light without changing gameplay truth.
- [X] Validation uses real repo infrastructure; any new screenshot/visual-regression requirement must include its own tooling story.
