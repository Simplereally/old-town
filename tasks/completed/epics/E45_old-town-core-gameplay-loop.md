...
- [X] Move completed story files into `tasks/completed/stories/E45/`.
- [X] Move this epic file into `tasks/completed/epics/` after all stories are complete.

## Ordered stories

- [X] `E45-S01` — [Starter spawn point and first-load bootstrap](../stories/E45/E45-S01_starter-spawn-point-and-first-load-bootstrap.md)
- [X] `E45-S02` — [Woodcutting and mining loops in the starter region](../stories/E45/E45-S02_woodcutting-and-mining-loops-in-the-starter-region.md)
- [X] `E45-S03` — [Smithing, cooking, and crafting processing loops](../stories/E45/E45-S03_smithing-cooking-and-crafting-processing-loops.md)
- [X] `E45-S04` — [Combat loop against cellar rats and mud goblins](../stories/E45/E45-S04_combat-loop-against-cellar-rats-and-mud-goblins.md)
- [X] `E45-S05` — [XP drops, level-ups, and skill panel wiring](../stories/E45/E45-S05_xp-drops-level-ups-and-skill-panel-wiring.md)
- [X] `E45-S06` — [End-to-end integration smoke test](../stories/E45/E45-S06_end-to-end-integration-smoke-test.md)

## Epic acceptance criteria

- [X] All listed story files are complete and moved to the completed folder.
- [X] A new player can spawn, walk around Old Town, and within an hour experience gather → process → fight → bank → level.
- [X] Resource nodes deplete and respawn correctly on the 600 ms tick.
- [X] Combat against cellar rats and mud goblins uses the attack/defence roll formula and shows hitsplats/XP.
- [X] XP drops and level-ups are visible in the client.
- [X] An automated end-to-end test exercises the first-hour loop (E45-S06).
- [X] All actions remain server-authoritative; the client only sends intents and renders deltas.
