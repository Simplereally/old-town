...
- [ ] Move completed story files into `tasks/completed/stories/E22/`.
- [ ] Move this epic file into `tasks/completed/epics/` after all stories are complete.

## Ordered stories

- [ ] `E22-S01` — [Bank Storage System Runtime](stories/E22/E22-S01_bank-storage-system-runtime.md)
- [ ] `E22-S02` — [Shop Trade Transaction System](stories/E22/E22-S02_shop-trade-transaction-system.md)
- [ ] `E22-S03` — [Economy UI Protocol and Client Rendering](stories/E22/E22-S03_economy-ui-protocol-and-client-rendering.md)
