...
- [ ] Move completed story files into `tasks/completed/stories/E12/`.
- [ ] Move this epic file into `tasks/completed/epics/` after all stories are complete.

## Ordered stories

- [ ] `E12-S01` — [Implement player var and quest var storage](../stories/E12/E12-S01_implement-player-var-and-quest-var-storage.md)
- [ ] `E12-S02` — [Implement dialogue graph engine](../stories/E12/E12-S02_implement-dialogue-graph-engine.md)
- [ ] `E12-S03` — [Implement quest requirement/objective/trigger engine](../stories/E12/E12-S03_implement-quest-requirement-objective-trigger-engine.md)
- [ ] `E12-S04` — [Implement quest rewards and completion safety](../stories/E12/E12-S04_implement-quest-rewards-and-completion-safety.md)
- [ ] `E12-S05` — [Wire Smoke Over Old Town end-to-end](../stories/E12/E12-S05_wire-smoke-over-old-town-end-to-end.md)
