...
- [`../../combat/signature-mechanics.md`](../../combat/signature-mechanics.md) — Weapon family identities and how Trophies support them
- [`../../combat/mechanics-implementation.md`](../../combat/mechanics-implementation.md) — Operational rules for Trophy mechanics
