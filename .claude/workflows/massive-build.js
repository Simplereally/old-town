  ...
  () =>
    agent(
      "Read these files and fix the type errors:\n" +
        ...
        "After fixing, run: cd old-town && bun run typecheck\n" +
  ...
  () =>
    agent(
      "Read these files and fix orphaned content warnings:\n" +
        ...
        "3. Run: cd old-town && bun run content:validate\n" +
  ...
  () =>
    agent(
      "Read these files:\n" +
        ...
        "Make sure the schema validates. Run: cd old-town && bun run content:validate\n" +
  ...
  () =>
    agent(
      "Read these files:\n" +
        ...
        "Run: cd old-town && bun run content:validate\n" +
  ...
  () =>
    agent(
      "Read these files:\n" +
        ...
        "Run: cd old-town && bun run format:check\n" +
