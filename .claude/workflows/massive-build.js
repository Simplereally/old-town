export const meta = {
  ...
  description: 'Execute 20+ agents across 6 phases to close all identified gaps in the Old Town game.',
  phases: [
    ...
    { title: 'Server Systems', detail: 'Implement death penalty, status effects, service fees, doors, spell effects' },
